...
namespace LightJson.Serialization
{
	...
	public sealed class JsonTextWriter
	{
		...
		public JsonTextWriter(TextWriter innerWriter) : this(innerWriter, false) { }
		...
		/// </param>
		public JsonTextWriter(TextWriter innerWriter, bool pretty)
		{
			if (pretty)
			{
				this.IndentString = "\t";
		...
		public static string Serialize(JsonValue value, bool pretty)
		{
			...
			{
				var jsonWriter = new JsonTextWriter(stringWriter, pretty);
